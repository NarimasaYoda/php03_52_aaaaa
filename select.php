...
// ※質問 htmlspecialcharsは、htmlに記載する時に設定すると記載するときに、設定すると講義でお聞きしました。
// しかし、今回は、phpの中で設定して（例：h($result[$result_T[6]])）してから、
// $view全体を、htmlに持っていっています。（例：<div ><？= $view ？></div>）
// この場合でも、htmlspecialcharsは有効なのでしょうか？
// （実際には、<div ><？= h($view) ？></div> とするとブラウザの表示ができず、このやり方でないとできなかったのですが。）
...
<header>
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="index.php">DB登録</a>
        </div>
    </div>
    </nav>
</header>
